...
class _TransactionApi implements TransactionApi {
  ...
  @override
  Future<Map<String, dynamic>> createDeposit(dynamic request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
  ...
  @override
  Future<Map<String, dynamic>> createWithdrawal(dynamic request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
  ...
  Future<Map<String, dynamic>> calculateTransactionFee(
    ...
    final _options = _setStreamType<Map<String, dynamic>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/transactions/calculate-fee',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<Map<String, dynamic>> handleWebhook(Map<String, dynamic> data) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<Map<String, dynamic>> getPendingReviewTransactions({
    ...
    final _options = _setStreamType<Map<String, dynamic>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/transactions/pending-review',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
