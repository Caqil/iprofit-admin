...
class EnhancedDatabaseSeeder {
  constructor(options) {
    this.options = options || {
      ...
      demo: false,
      count: {
        users: 10,           // Increased for better referral chains
        transactions: 30,    // More transactions for profit sharing
        loans: 20,
        tickets: 20,
        tasks: 15,
        news: 10
...
async resetDatabase() {
  ...
  const db = mongoose.connection.db;
    ...
    const settings = [
      ...
      },
      {
        ...
        isEditable: true,
        isEncrypted: false,
        validation: { required: true, pattern: /^[^\s@]+@[^\s@]+\.[^\s@]+$/.source },
        updatedBy: sampleAdminId,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        isEditable: true,
        isEncrypted: true, // This should be encrypted for security
        validation: { required: true },
        updatedBy: sampleAdminId,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        category: 'email',
        key: 'email_from_name',
        value: process.env.EMAIL_FROM_NAME || 'IProfit Platform',
        dataType: 'string',
      ...
      },
      {
        ...
        value: process.env.EMAIL_FROM_ADDRESS || process.env.SMTP_USER || '',
        dataType: 'email',
        description: 'Default sender email address',
        isEditable: true,
        isEncrypted: false,
        validation: { required: false, pattern: /^[^\s@]+@[^\s@]+\.[^\s@]+$/.source },
        updatedBy: sampleAdminId,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      ...
      },
      {
        ...
        isEditable: true,
        isEncrypted: false,
        validation: { required: false, min: 1, max: 20 },
        updatedBy: sampleAdminId,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      ...
      },
      {
        ...
        dataType: 'number',
        description: 'Delay between email retries (milliseconds)',
        isEditable: true,
        isEncrypted: false,
        validation: { required: false, min: 1000, max: 60000 },
        updatedBy: sampleAdminId,
        createdAt: new Date(),
        updatedAt: new Date()
      },
  ...
  value: false,
  dataType: 'boolean',
  description: 'Automatically approve bonuses for verified users',
  isEditable: true,
  isEncrypted: false,
  defaultValue: false,
  updatedBy: sampleAdminId,
...
{
  category: 'business',
  key: 'auto_bonus_max_amount',
  value: 1000,
  dataType: 'number',
  description: 'Maximum bonus amount for auto approval (BDT)',
  isEditable: true,
  isEncrypted: false,
  validation: { required: true, min: 1, max: 50000 },
  defaultValue: 1000,
  updatedBy: sampleAdminId,
  createdAt: new Date(),
  updatedAt: new Date()
...
{
  category: 'business',
  key: 'auto_bonus_min_account_age_days',
  value: 30,
  dataType: 'number',
  description: 'Minimum account age in days for auto bonus approval',
  isEditable: true,
  isEncrypted: false,
...
{
  category: 'business',
  key: 'auto_bonus_min_total_deposits',
  value: 1000,
  dataType: 'number',
  description: 'Minimum total deposits for auto bonus approval (BDT)',
  isEditable: true,
  isEncrypted: false,
